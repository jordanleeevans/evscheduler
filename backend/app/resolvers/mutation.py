...
async def resolve_create_vehicle(obj, info, name: str, battery_capacity_kwh: float, current_battery_pct: float):
...
async def resolve_schedule_charging_session(obj, info, vehicle_id: str, departure_time: str, target_charge_pct: float):
